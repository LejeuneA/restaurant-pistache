...
if (!($conn instanceof PDO)) {
    ...
    $results = getAllDessertsDB($conn, null, '1');
...
<html lang="en">
<head>
    <?php displayHeadSection('Menu - Desserts'); ?>
</head>
<body>
<header>
...
<main>
    <section class="hero-section hero-dessert">
        <h2>Indulge Yourself With Sweet Delights</h2>
        ...
        <div class="menu-container container">
            ...
            <div class="menu-items">
                <div class="menu-content" id="dessert-content">
                    <?= displayDesserts($execute, $results) ?>
                </div>
            </div>
        </div>
    </section>
