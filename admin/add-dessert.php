...
if (!is_object($conn)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['form']) && $_POST['form'] === 'add') {
        ...
        if ($_SESSION['user_permission'] == 1) {
            // Add the dessert to the database
            $addResult = addDessertDB($conn, $addData);

            // Check the result and display appropriate message
            if ($addResult === true) {

                $msg = getMessage('Dessert successfully added.', 'success');

                // Set session variable to indicate success
                $_SESSION['dessert_added'] = true;
                // Redirect to the same page to refresh and clear the form
                header('Location: add-dessert.php');
                exit();
            } else {
                $msg = getMessage('Error adding dessert. Please try again.', 'error');
            }
        } else {
            $msg = getMessage('You are not allowed to add a dessert.', 'error');
        }
    }
...
// Check if a dessert has been successfully added
if (isset($_SESSION['dessert_added']) && $_SESSION['dessert_added'] === true) {
    // Display success message
    $msg = getMessage('The dessert has been added successfully.', 'success');
    // Clear the session variable
    unset($_SESSION['dessert_added']);
}
...
<body>
    ...
    <div class="edit-content">
        ...
        <div class="edit-form container">
            <form id="add-dessert-form" action="add-dessert.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-top">
                    ...
                    <div class="form-left">
                        ...
                        <div class=" checkbox-ctrl">
                            ...
                            <?php displayFormRadioBtnArticlePublished(isset($dessert['active']) ? $dessert['active'] : 0, 'ADD'); ?>
                        </div>
                        <!-- Category -->
                        <div class="form-ctrl">
