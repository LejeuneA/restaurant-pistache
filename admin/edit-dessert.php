...
if ($dish === null) {
    rpAdminSetFlash(
        'The requested dessert was not found.',
        'error'
    );
...
if (
    ...
    if (!rpAdminCsrfIsValid()) {
        ...
        $message = getMessage(
            'Demo account: editing desserts is disabled.',
            'error'
        );
        ...
        if ($upload['error'] !== null) {
            ...
            $message = getMessage(
                'The dessert could not be updated.',
                'error'
            );
        }
    }
...
<head>
    <?php displayHeadSection('Editing a dessert'); ?>
</head>
