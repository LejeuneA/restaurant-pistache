...
if (
    ...
    if (!rpAdminCsrfIsValid()) {
        ...
        $message = getMessage(
            'Demo account: adding main courses is disabled.',
            'error'
        );
        ...
        if ($upload['error'] !== null) {
            ...
            if (
                ...
                rpAdminSetFlash(
                    'Main course successfully added.',
                    'success'
                );
            ...
            $message = getMessage(
                'The main course could not be added.',
                'error'
            );
        }
    }
...
<head>
    <?php displayHeadSection('Add a main course'); ?>
</head>
    ...
    <main class="edit-content">
        ...
        <div class="edit-title">
            ...
            <?php if (isGuest()): ?>
                <div class="message">
                    <?= getMessage(
                        'Demo account: you can fill in this form, but the main course will not be added.',
                        'info'
                    ) ?>
                </div>
            <?php endif; ?>
